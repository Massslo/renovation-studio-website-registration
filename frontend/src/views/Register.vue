<template>
    <div>
        <form @submit.prevent="checkForm">
          ...
          <h1 className="text-3xl font-bold text-center mb-10 mt-10 ml-10">
            Регистрация
          </h1>
      ...
      /*
            ...
            const validateEmail = () => {
              ...
              if (!email.value) {
                ...
                document.getementById("email").style.borderColor = "#8DD3BB";
              }
            };
       */
        ...
        const validateSurname = () => {
            ...
            if (!surname.value) {
                ...
                document.getElementById("surname").style.borderColor = "red";
                surnameError.value = 'Минимум 1 символ и максимум 50 символов.';
        ...
        const validateFirstName = () => {
            ...
            if (!firstName.value) {
                ...
                document.getElementById("firstName").style.borderColor = "red";
                firstNameError.value = 'Минимум 1 символ и максимум 50 символов.';
        ...
        const validatePatronymic = () => {
            ...
            if (!patronymic.value) {
              ...
              patronymicError.value = ''; // Очистка сообщения об ошибке, если валидация успешна
                ...
                patronymicError.value = 'Минимум 1 символ и максимум 50 символов.';
