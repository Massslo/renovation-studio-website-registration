        ...
        <div class="relative flex-grow max-w-full flex-1 px-4">
          ...
          <ul class="flex flex-wrap list-none pl-0 mb-0 flex-col">
            <li class="text-muted">
              ...
              ><router-link to="/PageNotFound">Проектирование</router-link></a>
            </li>
            <li class="text-muted">
              <a
                href="#"
            ...
            <li class="text-muted">
              <a
                href="#"
                class="text-sm text-bold font-montserrat inline-block py-2 px-4 no-underline p-0 text-gray-400"
              ><router-link to="/PageNotFound">Отделка и ремонт</router-link></a>
            </li>
            <li class="text-muted">
              <a
                href="#"
                class="text-sm text-bold font-montserrat inline-block py-2 px-4 no-underline p-0 text-gray-400"
              ><router-link to="/PageNotFound">Декорирование</router-link></a>
            </li>
          </ul>
        </div>
          ...
          <ul class="flex flex-wrap list-none pl-0 mb-0 flex-col">
            <li class="text-muted">
              <a
                href="#"
                class="text-sm text-bold font-montserrat inline-block py-2 px-4 no-underline p-0 text-gray-400"
              ><router-link to="/PageNotFound">Команда</router-link></a>
            </li>
            <li class="text-muted">
              <a
                href="#"
                class="text-sm text-bold font-montserrat inline-block py-2 px-4 no-underline p-0 text-gray-400"
              ><router-link to="/PageNotFound">Вакансии</router-link></a>
            </li>
            <li class="text-muted">
              <a
                href="#"
                class="text-sm text-bold font-montserrat inline-block py-2 px-4 no-underline p-0 text-gray-400"
              ><router-link to="/PageNotFound">Новости</router-link></a>
            </li>
          </ul>
        </div>
            ...
            <li class="text-muted">
              <div class="flex flex-wrap">
                ...
                <div class="relative flex-grow max-w-full flex-1 px-4">
                  ...
                  ><router-link to="/PageNotFound">8 999 888 22 55</router-link></a>
                </div>
              </div>
            </li>
            <li class="text-muted">
              <div class="flex flex-wrap">
                ...
                <div class="relative flex-grow max-w-full flex-1 px-4">
                  <a
                    href="#"
                    class="text-sm text-bold font-montserrat inline-block py-2 px-3 no-underline p-0 text-gray-400"
                  ><router-link to="/PageNotFound">г. Волгоград, <br>ул. Волгоградская, 1</router-link></a>
                </div>
              </div>
            </li>
            <li class="text-muted">
              <div class="flex flex-wrap">
                ...
                <div class="relative flex-grow max-w-full flex-1 px-4">
                  <a
                    href="#"
                    class="text-sm text-bold font-montserrat inline-block py-2 px-3 no-underline p-0 text-gray-400"
                  ><router-link to="/PageNotFound">pristroika@volsu.ru</router-link></a>
                </div>
              </div>
            </li>
          </ul>
