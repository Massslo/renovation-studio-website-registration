      ...
      <div class="flex flex-wrap  sm:px-4 mx-auto w-65">
        ...
        <div class="w-1/5 flex-grow max-w-full flex-1 px-4">
          <a
            ...
            href="#"
          ><router-link to="/PageNotFound">Портфолио</router-link></a>
        </div>
        <div class="w-1/5 flex-grow max-w-full flex-1 px-4">
          <a
            class="text-sm text-bold font-montserrat inline-block py-2 px-4 no-underline nav-item"
            href="#"
          ><router-link to="/PageNotFound">Цены</router-link></a>
        </div>
        <div class="w-1/5 flex-grow max-w-full flex-1 px-4">
          <a
            class="text-sm text-bold font-montserrat inline-block py-2 px-4 no-underline nav-item"
            href="#"
          ><router-link to="/PageNotFound">Отзывы</router-link></a>
        </div>
        <div class="w-1/5 flex-grow max-w-full flex-1 px-4">
          <button
            ...
            href="#"
          ><router-link to="/PageNotFound">Заказать ремонт</router-link>
          </button>
        </div>
      </div>
    </nav>
